...
os.environ["FB_MARKETPLACE_BATCH_CSV_PATH"] = str(_TEST_DATA_DIR / "fb_marketplace_batch.csv")
os.environ["FB_MARKETPLACE_BATCH_ARCHIVE_DIR"] = str(_TEST_DATA_DIR / "fb_marketplace_batch_archive")
